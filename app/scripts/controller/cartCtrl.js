/**
 * This controller has all methods related to cart
 */
app.controller('cartCtrl', ['$scope', '$cookies', '$rootScope', '$timeout', 'restServices', 'cartServices', 'paymentServices', function ($scope, $cookies, $rootScope, $timeout, restServices, cartServices, paymentServices) {
    ...
    /**
     *  This will get Cart Items which are already in cookies
     *  on page load
     */
    ...
    /**
     * When product added to cart this method called and
     * store prodcut in cookies and again calculate total
     * price to cart items
     */
    ...
    /**
     * This method check Is cart empty. is cart empty return
     * true to show Bag is empty on cart hover otherwise return
     * false
     */
